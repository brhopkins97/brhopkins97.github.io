...
tag: [Malware, RATs, DotNet]
image:
  path: /assets/img/posts/2025/async-rat/asyncrat-banner.png
---
...
So, with that introduction out of the way, let's dissect this rat!
...
![AsyncRAT sleep](assets/img/posts/2025/async-rat/sleep-time.png)
...
![AsyncRAT initialization](assets/img/posts/2025/async-rat/init-settings.png)

The configurations used by the malware, such as the C2 host and ports are indeed encrypted and encoded.

![AsyncRAT config](assets/img/posts/2025/async-rat/async-config.png)
...
![AsyncRAT config](assets/img/posts/2025/async-rat/async-decrypt.png)
...
![AsyncRAT anti analysis](assets/img/posts/2025/async-rat/anti-analysis.png)
...
![AsyncRAT mutex](assets/img/posts/2025/async-rat/mutex.png)
...
![AsyncRAT mutex](assets/img/posts/2025/async-rat/c2-sleep.png)

Following this is the `Reconnect()` method.

![AsyncRAT mutex](assets/img/posts/2025/async-rat/reconnect.png)
...
![AsyncRAT mutex](assets/img/posts/2025/async-rat/builder.png)

## Detection

Below is a Yara rule I've created to detect AsyncRAT samples from the version 3 builder. This rule is also available in my [GitHb repository](https://github.com/echo01409/Rulesets/blob/main/YARA/Windows/asyncrat.yar).
