...
Analysis of the decrypted second stage revealed a credential and cryptocurrency wallet stealer, with an embedded Windows PE executable extending the attack capability beyond the initial macOS Node.js environment. Command and control communication was conducted via GitLab, using the platform as a dead drop to blend C2 traffic with legitimate developer activity — a technique consistent with previously documented DPRK tradecraft.
